...
import {
  ...
  Box, Card, CardContent, Typography, Stack, Divider, CircularProgress, Snackbar, Alert
} from '@mui/material';
...
export default function CreateCourse() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error creando curso:', axiosError.message);
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Card elevation={3}>
        <CardContent>
          <Typography variant="h4" gutterBottom>Crear Nuevo Curso</Typography>
      ...
      {/* Snackbar para error de archivos */}
      <Snackbar
        open={showFileAlert}
      ...
      >
        <Alert onClose={() => setShowFileAlert(false)} severity="warning" sx={{ width: '100%' }}>
          Debes seleccionar imagen de perfil e imagen de banner.
        </Alert>
      </Snackbar>
    </Box>
  );
